    ...
    <AppLayout :seo="seo">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="text-center mb-8">
                <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-linear-to-r from-green-500 to-emerald-600 text-3xl mb-4 shadow-lg">🖊️</div>
            ...
            <div class="flex justify-center gap-3 mt-5 flex-wrap">
                <button
                    class="px-6 py-2.5 bg-linear-to-r from-green-500 to-emerald-600 text-white font-bold rounded-full hover:shadow-lg hover:scale-105 transition-all"
                    @click="downloadHtml"
                >⬇️ Export HTML</button>
                <button
                    class="px-6 py-2.5 bg-linear-to-r from-blue-500 to-indigo-600 text-white font-bold rounded-full hover:shadow-lg hover:scale-105 transition-all"
                    @click="downloadTxt"
                >⬇️ Export TXT</button>
                <button
