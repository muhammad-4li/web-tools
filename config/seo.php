...
return [
    'site_name'  => 'MA Tools',
    'base_url'   => env('APP_URL', 'https://ma-tools.com'),
    'default_og' => '/images/og-default.png',

    'pages' => [
        'home' => [
            'title'       => 'MA Tools — Free Online Web Tools',
        ...
        'image-crop' => [
            'title'       => 'Image Crop Tool — Free Online Image Cropper',
        ...
        'pdf-sign' => [
            'title'       => 'Add Signature to PDF — Free PDF Signature Tool',
        ...
        'text-editor' => [
            'title'       => 'Online Text Editor — Free Rich Text Editor',
